...
S_INFO_WINDCODE,S_TYPE_ST,ENTRY_DT,REMOVE_DT,ANN_DT,REASON,
a.object_id as    src_object_id,
a.opdate  as    src_opdate 
from   eterminal.AShareST  a  
where   to_char(a.opdate,'YYYY-MM-DD') >='%s'
""" % (dodate)

cols = """
ticker,S_INFO_WINDCODE,S_TYPE_ST,ENTRY_DT,REMOVE_DT,ANN_DT,REASON,src_object_id,src_opdate
"""
